...
export class AIController {
  ...
  static async streamGenerate(req: Request, res: Response, next: NextFunction) {
    ...
    try {
      ...
      const result = await AIService.generateCode(projectId as string, prompt as string, (status: string) => {
