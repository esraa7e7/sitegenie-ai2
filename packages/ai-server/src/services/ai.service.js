...
export class AIService {
    static async generateCode(projectId, prompt, onProgress) {
        ...
        if (result.files) {
            ...
            await FileService.syncProjectToDisk(projectId, result.files);
