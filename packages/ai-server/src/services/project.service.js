...
export class ProjectService {
    constructor() {
        Object.defineProperty(this, "projectRepo", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    async getProjectDetails(tenantId, projectId) {
        const project = await this.projectRepo.findByTenantAndId(tenantId, projectId);
        if (!project)
            throw new NotFoundError('Project not found');
        return project;
    }
    async createProject(tenantId, name, description) {
    ...
    async updateProjectFile(projectId, filePath, content) {
